...
// French Republican calendar month-tag round-trip + validation.
...
describe("all 13 French Republican months round-trip", () => {
...
describe("epoch marker is illegal in this calendar", () => {
...
describe("a non-French-Republican date is never flagged", () => {
